...
TFile *_file0 = TFile::Open("TTbarPt_TTbarMC.root");

    TH1F *ho = (TH1F*)_file0->Get("NunuPt_MET1503jge0bMT150_TTbarMC");
    TH1F *htemp = (TH1F*)_file0->Get("NunuPt_MET150ge4jge0bMT150_TTbarMC");
    ho->Add(htemp);
//h->Rebin(2);
...
TH1F *hDataweight0b = (TH1F*)h->Clone("NuNuPtPhotPtWeight0bData");

//TH1F *hMCweight1b = (TH1F*)h->Clone("NuPtPhotPtWeight1bMC");
TH1F *hMCweight0b = (TH1F*)h->Clone("NuNuPtPhotPtWeight0bMC");
...
TFile *f = new TFile("Weights_NuNuPtVsPhotPt.root","RECREATE");
f->cd();
//hDataweight1b->Write();
hDataweight0b->Write();
//hMCweight1b->Write();
