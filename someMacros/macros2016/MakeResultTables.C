...
void MakeResultTables(TString inputfile){
  ...
  *fLogStream << "\\hline" << endl
    	      << " & \\multicolumn{11}{l|}{Compressed $\\PSGcpmDo-\\PSGczDo$: $2$ jets, $t_\\mathrm{mod}>6.4$} \\\\" << endl
    //<< " & \\multicolumn{11}{l|}{Compressed $\\tilde{\\chi}_{1}^{\\pm}-\\tilde{\\chi}_{1}^{0}$: $2$ jets, $t_\\mathrm{mod}>6.4$} \\\\" << endl
	      << "\\hline" << endl;
      *fLogStream << "$250-350$    & " << fixed << setprecision(2) << LL->GetBinContent(1) << "&" << LL->GetBinError(1) << " & " << W1l->GetBinContent(1) << "&" << W1l->GetBinError(1) << " & " << tt1l->GetBinContent(1) << "&" << tt1l->GetBinError(1) << " & " << ttz->GetBinContent(1) << "&" << ttz->GetBinError(1) << " & " << bg->GetBinContent(1) << "&" << bg->GetBinError(1) << " & " << int(Data->GetBinContent(1)) << " \\\\" << endl;
    *fLogStream << "$>350$    & " << fixed << setprecision(2) << LL->GetBinContent(2) << "&" << LL->GetBinError(2) << " & " << W1l->GetBinContent(2) << "&" << W1l->GetBinError(2) << " & " << tt1l->GetBinContent(2) << "&" << tt1l->GetBinError(2) << " & " << ttz->GetBinContent(2) << "&" << ttz->GetBinError(2) << " & " << bg->GetBinContent(2) << "&" << bg->GetBinError(2) << " & " << int(Data->GetBinContent(2)) << " \\\\" << endl;
  *fLogStream << "\\hline" << endl
    ...
    *fLogStream << "$>350$    & " << fixed << setprecision(2) << LL->GetBinContent(4) << "&" << LL->GetBinError(4) << " & " << W1l->GetBinContent(4) << "&" << W1l->GetBinError(4) << " & " << tt1l->GetBinContent(4) << "&" << tt1l->GetBinError(4) << " & " << ttz->GetBinContent(4) << "&" << ttz->GetBinError(4) << " & " << bg->GetBinContent(4) << "&" << bg->GetBinError(4) << " & " << int(Data->GetBinContent(4)) << " \\\\" << endl;
  *fLogStream << "\\hline" << endl
	      << " & \\multicolumn{11}{l|}{Low $\\Delta M$: $\\geq4$ jets, $\\MTtW\\leq200\\GeV$} \\\\" << endl
	      << "\\hline" << endl;
  *fLogStream << "$250-325$ & " << fixed << setprecision(2) << LL->GetBinContent(5) << "&" << LL->GetBinError(5) << " & " << W1l->GetBinContent(5) << "&" << W1l->GetBinError(5) << " & " << tt1l->GetBinContent(5) << "&" << tt1l->GetBinError(5) << " & " << ttz->GetBinContent(5) << "&" << ttz->GetBinError(5) << " & " << bg->GetBinContent(5) << "&" << bg->GetBinError(5) << " & " << int(Data->GetBinContent(5)) << " \\\\" << endl;
  *fLogStream << "$>325$ & " << fixed << setprecision(2) << LL->GetBinContent(6) << "&" << LL->GetBinError(6) << " & " << W1l->GetBinContent(6) << "&" << W1l->GetBinError(6) << " & " << tt1l->GetBinContent(6) << "&" << tt1l->GetBinError(6) << " & " << ttz->GetBinContent(6) << "&" << ttz->GetBinError(6) << " & " << bg->GetBinContent(6) << "&" << bg->GetBinError(6) << " & " << int(Data->GetBinContent(6)) << " \\\\" << endl;
  *fLogStream << "\\hline" << endl
	      << " & \\multicolumn{11}{l|}{High $\\Delta M$: $\\geq4$ jets, $\\MTtW>200\\GeV$} \\\\" << endl
	      << "\\hline" << endl;
  *fLogStream << "$250-350$ & " << fixed << setprecision(2) << LL->GetBinContent(7) << "&" << LL->GetBinError(7) << " & " << W1l->GetBinContent(7) << "&" << W1l->GetBinError(7) << " & " << tt1l->GetBinContent(7) << "&" << tt1l->GetBinError(7) << " & " << ttz->GetBinContent(7) << "&" << ttz->GetBinError(7) << " & " << bg->GetBinContent(7) << "&" << bg->GetBinError(7) << " & " << int(Data->GetBinContent(7)) << " \\\\" << endl;
  *fLogStream << "$350-450$ & " << fixed << setprecision(2) << LL->GetBinContent(8) << "&" << LL->GetBinError(8) << " & " << W1l->GetBinContent(8) << "&" << W1l->GetBinError(8) << " & " << tt1l->GetBinContent(8) << "&" << tt1l->GetBinError(8) << " & " << ttz->GetBinContent(8) << "&" << ttz->GetBinError(8) << " & " << bg->GetBinContent(8) << "&" << bg->GetBinError(8) << " & " << int(Data->GetBinContent(8)) << " \\\\" << endl;
  *fLogStream << "$>450$ & " << fixed << setprecision(2) << LL->GetBinContent(9) << "&" << LL->GetBinError(9) << " & " << W1l->GetBinContent(9) << "&" << W1l->GetBinError(9) << " & " << tt1l->GetBinContent(9) << "&" << tt1l->GetBinError(9) << " & " << ttz->GetBinContent(9) << "&" << ttz->GetBinError(9) << " & " << bg->GetBinContent(9) << "&" << bg->GetBinError(9) << " & " << int(Data->GetBinContent(9)) << " \\\\" << endl;
  *fLogStream << "\\hline" << endl
	      << "\\end{tabular}" << endl
	      << "\\end{center}"  << endl
	      << "\\end{table}"   << endl
