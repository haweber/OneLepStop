...
// makeCMS3ClassFiles("/nfs-7/userdata/dsklein/tupler_babies/merged/Stop_1l/v24/skim/ttWJets_13TeV_madgraphMLM.root", "t", "CMS3", "tas", "cms3")
...
namespace tas {
  ...
  extern "C" void Init(TTree *tree);
  extern "C" void GetEntry(unsigned int idx);
  extern "C" void LoadAllBranches();
  extern "C" void progress(int nEventsTotal, int nEventsChain);

  extern "C" const unsigned int &run();
  extern "C" const unsigned int &ls();
  extern "C" const unsigned int &evt();
  extern "C" const int &nvtxs();
  extern "C" const int &pu_nvtxs();
  extern "C" const float &pfmet();
  extern "C" const float &pfmet_phi();
  extern "C" const float &pfmet_jup();
  extern "C" const float &pfmet_phi_jup();
  extern "C" const float &pfmet_jdown();
  extern "C" const float &pfmet_phi_jdown();
  extern "C" const float &pfmet_rl();
  extern "C" const float &pfmet_phi_rl();
  extern "C" const float &pfmet_rl_jup();
  extern "C" const float &pfmet_phi_rl_jup();
  extern "C" const float &pfmet_rl_jdown();
  extern "C" const float &pfmet_phi_rl_jdown();
  extern "C" const float &pfmet_egclean();
  extern "C" const float &pfmet_egclean_phi();
  extern "C" const float &pfmet_muegclean();
  extern "C" const float &pfmet_muegclean_phi();
  extern "C" const float &pfmet_muegcleanfix();
  extern "C" const float &pfmet_muegcleanfix_phi();
  extern "C" const float &pfmet_uncorr();
  extern "C" const float &pfmet_uncorr_phi();
  extern "C" const float &pfmet_original();
  extern "C" const float &pfmet_original_phi();
  extern "C" const float &scale1fb();
  extern "C" const float &xsec();
  extern "C" const float &xsec_uncert();
  extern "C" const float &kfactor();
  extern "C" const float &pu_ntrue();
  extern "C" const int &ngoodleps();
  extern "C" const int &nlooseleps();
  extern "C" const int &nvetoleps();
  extern "C" const bool &is_data();
  extern "C" const string &dataset();
  extern "C" const string &filename();
  extern "C" const string &cms3tag();
  extern "C" const unsigned int &nEvents();
  extern "C" const unsigned int &nEvents_goodvtx();
  extern "C" const unsigned int &nEvents_MET30();
  extern "C" const unsigned int &nEvents_1goodlep();
  extern "C" const unsigned int &nEvents_2goodjets();
  extern "C" const int &is0lep();
  extern "C" const int &is1lep();
  extern "C" const int &is2lep();
  extern "C" const int &isZtoNuNu();
  extern "C" const int &is1lepFromW();
  extern "C" const int &is1lepFromTop();
  extern "C" const float &MT2W();
  extern "C" const float &MT2W_rl();
  extern "C" const float &mindphi_met_j1_j2();
  extern "C" const float &mindphi_met_j1_j2_rl();
  extern "C" const float &mt_met_lep();
  extern "C" const float &mt_met_lep_rl();
  extern "C" const float &MT2W_jup();
  extern "C" const float &MT2W_rl_jup();
  extern "C" const float &mindphi_met_j1_j2_jup();
  extern "C" const float &mindphi_met_j1_j2_rl_jup();
  extern "C" const float &mt_met_lep_jup();
  extern "C" const float &mt_met_lep_rl_jup();
  extern "C" const float &MT2W_jdown();
  extern "C" const float &MT2W_rl_jdown();
  extern "C" const float &mindphi_met_j1_j2_jdown();
  extern "C" const float &mindphi_met_j1_j2_rl_jdown();
  extern "C" const float &mt_met_lep_jdown();
  extern "C" const float &mt_met_lep_rl_jdown();
  extern "C" const float &hadronic_top_chi2();
  extern "C" const float &ak4pfjets_rho();
  extern "C" const float &pdf_up_weight();
  extern "C" const float &pdf_down_weight();
  extern "C" const vector<string> &genweightsID();
  extern "C" const vector<float> &genweights();
  extern "C" const float &weight_btagsf();
  extern "C" const float &weight_btagsf_heavy_UP();
  extern "C" const float &weight_btagsf_light_UP();
  extern "C" const float &weight_btagsf_heavy_DN();
  extern "C" const float &weight_btagsf_light_DN();
  extern "C" const float &weight_btagsf_fastsim_UP();
  extern "C" const float &weight_btagsf_fastsim_DN();
  extern "C" const float &weight_analysisbtagsf();
  extern "C" const float &weight_analysisbtagsf_heavy_UP();
  extern "C" const float &weight_analysisbtagsf_light_UP();
  extern "C" const float &weight_analysisbtagsf_heavy_DN();
  extern "C" const float &weight_analysisbtagsf_light_DN();
  extern "C" const float &weight_analysisbtagsf_fastsim_UP();
  extern "C" const float &weight_analysisbtagsf_fastsim_DN();
  extern "C" const float &weight_tightbtagsf();
  extern "C" const float &weight_tightbtagsf_heavy_UP();
  extern "C" const float &weight_tightbtagsf_light_UP();
  extern "C" const float &weight_tightbtagsf_heavy_DN();
  extern "C" const float &weight_tightbtagsf_light_DN();
  extern "C" const float &weight_tightbtagsf_fastsim_UP();
  extern "C" const float &weight_tightbtagsf_fastsim_DN();
  extern "C" const float &weight_loosebtagsf();
  extern "C" const float &weight_loosebtagsf_heavy_UP();
  extern "C" const float &weight_loosebtagsf_light_UP();
  extern "C" const float &weight_loosebtagsf_heavy_DN();
  extern "C" const float &weight_loosebtagsf_light_DN();
  extern "C" const float &weight_loosebtagsf_fastsim_UP();
  extern "C" const float &weight_loosebtagsf_fastsim_DN();
  extern "C" const float &weight_lepSF();
  extern "C" const float &weight_lepSF_up();
  extern "C" const float &weight_lepSF_down();
  extern "C" const float &weight_vetoLepSF();
  extern "C" const float &weight_vetoLepSF_up();
  extern "C" const float &weight_vetoLepSF_down();
  extern "C" const float &weight_lepSF_fastSim();
  extern "C" const float &weight_lepSF_fastSim_up();
  extern "C" const float &weight_lepSF_fastSim_down();
  extern "C" const float &weight_ISR();
  extern "C" const float &weight_ISRup();
  extern "C" const float &weight_ISRdown();
  extern "C" const float &weight_PU();
  extern "C" const float &weight_PUup();
  extern "C" const float &weight_PUdown();
  extern "C" const float &weight_ISRnjets();
  extern "C" const float &weight_ISRnjets_UP();
  extern "C" const float &weight_ISRnjets_DN();
  extern "C" const int &NISRjets();
  extern "C" const int &NnonISRjets();
  extern "C" const vector<string> &sparms_names();
  extern "C" const vector<float> &sparms_values();
  extern "C" const int &sparms_subProcessId();
  extern "C" const float &mass_lsp();
  extern "C" const float &mass_chargino();
  extern "C" const float &mass_stop();
  extern "C" const float &mass_gluino();
  extern "C" const float &genmet();
  extern "C" const float &genmet_phi();
  extern "C" const float &nupt();
  extern "C" const float &genht();
  extern "C" const bool &PassTrackVeto();
  extern "C" const bool &PassTauVeto();
  extern "C" const float &topness();
  extern "C" const float &topnessMod();
  extern "C" const float &topnessMod_rl();
  extern "C" const float &topnessMod_jup();
  extern "C" const float &topnessMod_rl_jup();
  extern "C" const float &topnessMod_jdown();
  extern "C" const float &topnessMod_rl_jdown();
  extern "C" const float &Mlb_closestb();
  extern "C" const float &Mlb_lead_bdiscr();
  extern "C" const float &Mlb_closestb_jup();
  extern "C" const float &Mlb_lead_bdiscr_jup();
  extern "C" const float &Mlb_closestb_jdown();
  extern "C" const float &Mlb_lead_bdiscr_jdown();
  extern "C" const int &HLT_SingleEl();
  extern "C" const int &HLT_SingleMu();
  extern "C" const int &HLT_MET();
  extern "C" const int &HLT_MET_MHT();
  extern "C" const int &HLT_MET100_MHT100();
  extern "C" const int &HLT_MET110_MHT110();
  extern "C" const int &HLT_MET120_MHT120();
  extern "C" const int &HLT_PFHT_unprescaled();
  extern "C" const int &HLT_PFHT_prescaled();
  extern "C" const int &HLT_DiEl();
  extern "C" const int &HLT_DiMu();
  extern "C" const int &HLT_MuE();
  extern "C" const int &nPhotons();
  extern "C" const int &ph_ngoodjets();
  extern "C" const int &ph_ngoodbtags();
  extern "C" const float &hardgenpt();
  extern "C" const float &calomet();
  extern "C" const float &calomet_phi();
  extern "C" const int &lep1_pdgid();
  extern "C" const int &lep1_production_type();
  extern "C" const float &lep1_MiniIso();
  extern "C" const float &lep1_relIso();
  extern "C" const bool &lep1_passLooseID();
  extern "C" const bool &lep1_passMediumID();
  extern "C" const bool &lep1_passTightID();
  extern "C" const bool &lep1_passVeto();
  extern "C" const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lep1_p4();
  extern "C" const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lep1_mcp4();
  extern "C" const int &lep1_mc_motherid();
  extern "C" const float &lep1_dphiMET();
  extern "C" const float &lep1_dphiMET_jup();
  extern "C" const float &lep1_dphiMET_jdown();
  extern "C" const float &lep1_dphiMET_rl();
  extern "C" const float &lep1_dphiMET_rl_jup();
  extern "C" const float &lep1_dphiMET_rl_jdown();
  extern "C" const int &lep2_pdgid();
  extern "C" const int &lep2_production_type();
  extern "C" const float &lep2_MiniIso();
  extern "C" const float &lep2_relIso();
  extern "C" const bool &lep2_passLooseID();
  extern "C" const bool &lep2_passMediumID();
  extern "C" const bool &lep2_passTightID();
  extern "C" const bool &lep2_passVeto();
  extern "C" const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lep2_p4();
  extern "C" const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lep2_mcp4();
  extern "C" const int &lep2_mc_motherid();
  extern "C" const float &lep2_dphiMET();
  extern "C" const float &lep2_dphiMET_jup();
  extern "C" const float &lep2_dphiMET_jdown();
  extern "C" const float &lep2_dphiMET_rl();
  extern "C" const float &lep2_dphiMET_rl_jup();
  extern "C" const float &lep2_dphiMET_rl_jdown();
  extern "C" const vector<float> &ph_sigmaIEtaEta_fill5x5();
  extern "C" const vector<float> &ph_hOverE();
  extern "C" const vector<float> &ph_r9();
  extern "C" const vector<float> &ph_chiso();
  extern "C" const vector<float> &ph_nhiso();
  extern "C" const vector<float> &ph_phiso();
  extern "C" const vector<int> &ph_overlapJetId();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ph_p4();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ph_mcp4();
  extern "C" const vector<float> &ph_pt();
  extern "C" const vector<float> &ph_eta();
  extern "C" const vector<float> &ph_phi();
  extern "C" const vector<float> &ph_mass();
  extern "C" const vector<int> &ph_mcMatchId();
  extern "C" const vector<float> &ph_genIso04();
  extern "C" const vector<float> &ph_drMinParton();
  extern "C" const int &ngoodjets();
  extern "C" const int &ngoodbtags();
  extern "C" const int &nloosebtags();
  extern "C" const int &ntightbtags();
  extern "C" const int &nanalysisbtags();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &softtags_p4();
  extern "C" const int &nsoftbtags();
  extern "C" const float &ak4_HT();
  extern "C" const float &ak4_htratiom();
  extern "C" const vector<float> &dphi_ak4pfjet_met();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ak4pfjets_p4();
  extern "C" const vector<bool> &ak4pfjets_passMEDbtag();
  extern "C" const vector<float> &ak4pfjets_CSV();
  extern "C" const vector<float> &ak4pfjets_mva();
  extern "C" const vector<int> &ak4pfjets_parton_flavor();
  extern "C" const vector<int> &ak4pfjets_hadron_flavor();
  extern "C" const vector<bool> &ak4pfjets_loose_puid();
  extern "C" const vector<bool> &ak4pfjets_loose_pfid();
  extern "C" const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &ak4pfjets_leadMEDbjet_p4();
  extern "C" const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &ak4pfjets_leadbtag_p4();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ak4genjets_p4();
  extern "C" const int &jup_ngoodjets();
  extern "C" const int &jup_ngoodbtags();
  extern "C" const int &jup_nloosebtags();
  extern "C" const int &jup_ntightbtags();
  extern "C" const int &jup_nanalysisbtags();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_softtags_p4();
  extern "C" const int &jup_nsoftbtags();
  extern "C" const float &jup_ak4_HT();
  extern "C" const float &jup_ak4_htratiom();
  extern "C" const vector<float> &jup_dphi_ak4pfjet_met();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_ak4pfjets_p4();
  extern "C" const vector<bool> &jup_ak4pfjets_passMEDbtag();
  extern "C" const vector<float> &jup_ak4pfjets_CSV();
  extern "C" const vector<float> &jup_ak4pfjets_mva();
  extern "C" const vector<int> &jup_ak4pfjets_parton_flavor();
  extern "C" const vector<int> &jup_ak4pfjets_hadron_flavor();
  extern "C" const vector<bool> &jup_ak4pfjets_loose_puid();
  extern "C" const vector<bool> &jup_ak4pfjets_loose_pfid();
  extern "C" const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &jup_ak4pfjets_leadMEDbjet_p4();
  extern "C" const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &jup_ak4pfjets_leadbtag_p4();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_ak4genjets_p4();
  extern "C" const int &jdown_ngoodjets();
  extern "C" const int &jdown_ngoodbtags();
  extern "C" const int &jdown_nloosebtags();
  extern "C" const int &jdown_ntightbtags();
  extern "C" const int &jdown_nanalysisbtags();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_softtags_p4();
  extern "C" const int &jdown_nsoftbtags();
  extern "C" const float &jdown_ak4_HT();
  extern "C" const float &jdown_ak4_htratiom();
  extern "C" const vector<float> &jdown_dphi_ak4pfjet_met();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_ak4pfjets_p4();
  extern "C" const vector<bool> &jdown_ak4pfjets_passMEDbtag();
  extern "C" const vector<float> &jdown_ak4pfjets_CSV();
  extern "C" const vector<float> &jdown_ak4pfjets_mva();
  extern "C" const vector<int> &jdown_ak4pfjets_parton_flavor();
  extern "C" const vector<int> &jdown_ak4pfjets_hadron_flavor();
  extern "C" const vector<bool> &jdown_ak4pfjets_loose_puid();
  extern "C" const vector<bool> &jdown_ak4pfjets_loose_pfid();
  extern "C" const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &jdown_ak4pfjets_leadMEDbjet_p4();
  extern "C" const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &jdown_ak4pfjets_leadbtag_p4();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_ak4genjets_p4();
  extern "C" const vector<bool> &genleps_isfromt();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genleps_p4();
  extern "C" const vector<int> &genleps_id();
  extern "C" const vector<int> &genleps__genpsidx();
  extern "C" const vector<int> &genleps_status();
  extern "C" const vector<bool> &genleps_fromHardProcessDecayed();
  extern "C" const vector<bool> &genleps_fromHardProcessFinalState();
  extern "C" const vector<bool> &genleps_isHardProcess();
  extern "C" const vector<bool> &genleps_isLastCopy();
  extern "C" const vector<int> &genleps_gentaudecay();
  extern "C" const int &gen_nfromtleps_();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genleps_motherp4();
  extern "C" const vector<int> &genleps_motherid();
  extern "C" const vector<int> &genleps_motheridx();
  extern "C" const vector<int> &genleps_motherstatus();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genleps_gmotherp4();
  extern "C" const vector<int> &genleps_gmotherid();
  extern "C" const vector<int> &genleps_gmotheridx();
  extern "C" const vector<int> &genleps_gmotherstatus();
  extern "C" const vector<bool> &gennus_isfromt();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gennus_p4();
  extern "C" const vector<int> &gennus_id();
  extern "C" const vector<int> &gennus__genpsidx();
  extern "C" const vector<int> &gennus_status();
  extern "C" const vector<bool> &gennus_fromHardProcessDecayed();
  extern "C" const vector<bool> &gennus_fromHardProcessFinalState();
  extern "C" const vector<bool> &gennus_isHardProcess();
  extern "C" const vector<bool> &gennus_isLastCopy();
  extern "C" const vector<int> &gennus_gentaudecay();
  extern "C" const int &gen_nfromtnus_();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gennus_motherp4();
  extern "C" const vector<int> &gennus_motherid();
  extern "C" const vector<int> &gennus_motheridx();
  extern "C" const vector<int> &gennus_motherstatus();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gennus_gmotherp4();
  extern "C" const vector<int> &gennus_gmotherid();
  extern "C" const vector<int> &gennus_gmotheridx();
  extern "C" const vector<int> &gennus_gmotherstatus();
  extern "C" const vector<bool> &genqs_isfromt();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genqs_p4();
  extern "C" const vector<int> &genqs_id();
  extern "C" const vector<int> &genqs__genpsidx();
  extern "C" const vector<int> &genqs_status();
  extern "C" const vector<bool> &genqs_fromHardProcessDecayed();
  extern "C" const vector<bool> &genqs_fromHardProcessFinalState();
  extern "C" const vector<bool> &genqs_isHardProcess();
  extern "C" const vector<bool> &genqs_isLastCopy();
  extern "C" const vector<int> &genqs_gentaudecay();
  extern "C" const int &gen_nfromtqs_();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genqs_motherp4();
  extern "C" const vector<int> &genqs_motherid();
  extern "C" const vector<int> &genqs_motheridx();
  extern "C" const vector<int> &genqs_motherstatus();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genqs_gmotherp4();
  extern "C" const vector<int> &genqs_gmotherid();
  extern "C" const vector<int> &genqs_gmotheridx();
  extern "C" const vector<int> &genqs_gmotherstatus();
  extern "C" const vector<bool> &genbosons_isfromt();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genbosons_p4();
  extern "C" const vector<int> &genbosons_id();
  extern "C" const vector<int> &genbosons__genpsidx();
  extern "C" const vector<int> &genbosons_status();
  extern "C" const vector<bool> &genbosons_fromHardProcessDecayed();
  extern "C" const vector<bool> &genbosons_fromHardProcessFinalState();
  extern "C" const vector<bool> &genbosons_isHardProcess();
  extern "C" const vector<bool> &genbosons_isLastCopy();
  extern "C" const vector<int> &genbosons_gentaudecay();
  extern "C" const int &gen_nfromtbosons_();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genbosons_motherp4();
  extern "C" const vector<int> &genbosons_motherid();
  extern "C" const vector<int> &genbosons_motheridx();
  extern "C" const vector<int> &genbosons_motherstatus();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genbosons_gmotherp4();
  extern "C" const vector<int> &genbosons_gmotherid();
  extern "C" const vector<int> &genbosons_gmotheridx();
  extern "C" const vector<int> &genbosons_gmotherstatus();
  extern "C" const vector<bool> &gensusy_isfromt();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gensusy_p4();
  extern "C" const vector<int> &gensusy_id();
  extern "C" const vector<int> &gensusy__genpsidx();
  extern "C" const vector<int> &gensusy_status();
  extern "C" const vector<bool> &gensusy_fromHardProcessDecayed();
  extern "C" const vector<bool> &gensusy_fromHardProcessFinalState();
  extern "C" const vector<bool> &gensusy_isHardProcess();
  extern "C" const vector<bool> &gensusy_isLastCopy();
  extern "C" const vector<int> &gensusy_gentaudecay();
  extern "C" const int &gen_nfromtsusy_();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gensusy_motherp4();
  extern "C" const vector<int> &gensusy_motherid();
  extern "C" const vector<int> &gensusy_motheridx();
  extern "C" const vector<int> &gensusy_motherstatus();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gensusy_gmotherp4();
  extern "C" const vector<int> &gensusy_gmotherid();
  extern "C" const vector<int> &gensusy_gmotheridx();
  extern "C" const vector<int> &gensusy_gmotherstatus();
  extern "C" const vector<TString> &tau_IDnames();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &tau_leadtrack_p4();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &tau_leadneutral_p4();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &tau_p4();
  extern "C" const vector<vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > > &tau_isocand_p4();
  extern "C" const vector<vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > > &tau_sigcand_p4();
  extern "C" const vector<vector<float> > &tau_ID();
  extern "C" const vector<float> &tau_passID();
  extern "C" const int &ngoodtaus();
  extern "C" const vector<float> &tau_againstMuonTight();
  extern "C" const vector<float> &tau_againstElectronLoose();
  extern "C" const vector<bool> &tau_isVetoTau();
  extern "C" const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &isoTracks_p4();
  extern "C" const vector<int> &isoTracks_charge();
  extern "C" const vector<float> &isoTracks_absIso();
  extern "C" const vector<float> &isoTracks_dz();
  extern "C" const vector<int> &isoTracks_pdgId();
  extern "C" const vector<bool> &isoTracks_isVetoTrack();
  extern "C" const vector<bool> &isoTracks_isVetoTrack_v2();
  extern "C" const vector<bool> &isoTracks_isVetoTrack_v3();
  extern "C" const float &filt_cscbeamhalo();
  extern "C" const float &filt_cscbeamhalo2015();
  extern "C" const float &filt_globaltighthalo2016();
  extern "C" const float &filt_globalsupertighthalo2016();
  extern "C" const float &filt_ecallaser();
  extern "C" const float &filt_ecaltp();
  extern "C" const float &filt_eebadsc();
  extern "C" const float &filt_goodvtx();
  extern "C" const float &filt_badevents();
  extern "C" const float &filt_hbhenoise();
  extern "C" const float &filt_hbheisonoise();
  extern "C" const float &filt_hcallaser();
  extern "C" const float &filt_trkfail();
  extern "C" const float &filt_trkPOG();
  extern "C" const float &filt_trkPOG_logerr_tmc();
  extern "C" const float &filt_trkPOG_tmc();
  extern "C" const float &filt_trkPOG_tms();
  extern "C" const int &firstGoodVtxIdx();
  extern "C" const float &filt_badChargedCandidateFilter();
  extern "C" const float &filt_badMuonFilter();
  extern "C" const float &filt_met();
  extern "C" const bool &filt_fastsimjets();
  extern "C" const bool &filt_fastsimjets_jup();
  extern "C" const bool &filt_fastsimjets_jdown();
  extern "C" const bool &filt_jetWithBadMuon();
  extern "C" const bool &filt_jetWithBadMuon_jup();
  extern "C" const bool &filt_jetWithBadMuon_jdown();
  extern "C" const bool &filt_pfovercalomet();
  extern "C" const bool &filt_badmuons();
  extern "C" const bool &filt_duplicatemuons();
  extern "C" const bool &filt_nobadmuons();
}
#endif
