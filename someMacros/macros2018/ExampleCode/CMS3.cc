...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &softtags_p4() { return cms3.softtags_p4(); }
const int &nsoftbtags() { return cms3.nsoftbtags(); }
...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_softtags_p4() { return cms3.jup_softtags_p4(); }
const int &jup_nsoftbtags() { return cms3.jup_nsoftbtags(); }
...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_softtags_p4() { return cms3.jdown_softtags_p4(); }
const int &jdown_nsoftbtags() { return cms3.jdown_nsoftbtags(); }
