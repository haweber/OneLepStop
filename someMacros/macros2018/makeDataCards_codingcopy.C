...
int minstopmass(TString signaltype){
  if(signaltype.Contains("T8bbstausnu")) return 150;
...
int maxstopmass(TString signaltype){
  if(signaltype.Contains("T8bbstausnu")) return 1200;
...
int minlspmass(TString signaltype){
  if(signaltype.Contains("T8bbstausnu")) return 0;
...
int maxlspmass(TString signaltype){
  if(signaltype.Contains("T8bbstausnu")) return 650;
