...
void MakeResultPlots(TString inputfile){
  ...
  */
  ...
  //regions
  TLatex *tbDM = new TLatex(0.175,0.875,"#splitline{Boosted}{High #DeltaM}");
  tbDM->SetNDC();
  ...
  l1->SetLineWidth(2);
  l1->Draw();
  TLatex *tlDM = new TLatex(0.375,0.875,"Low #DeltaM");
  tlDM->SetNDC();
  ...
  l2->SetLineWidth(2);
  l2->Draw();
  TLatex *thDM = new TLatex(0.7,0.875,"High #DeltaM");
  thDM->SetNDC();
