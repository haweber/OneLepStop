...
void MakePrePostfitPlots2017(){
    
    TFile *f = new TFile("ResultRootFileMoriond17.root");
  f->cd();
  TH1D *tData = (TH1D*)f->Get("rpt_Data");
    TFile *f2 = new TFile("../Interpretation/PreAndPostfit_36p6fbinv.root");
    f2->cd();
    TH1D *tprefit = (TH1D*)f2->Get("PrefitBG");
    TH1D *tpostfit = (TH1D*)f2->Get("PostfitBG");

  //TH1D *Data = (TH1D*)tData  ->Clone("Data");
  TH1D *prefit   = (TH1D*)tprefit  ->Clone("Prefit");
  TH1D *postfit  = (TH1D*)tpostfit ->Clone("Postfit");
    TH1D *Data = new TH1D("Data","",31,0,31);
   ...
   gStyle->SetHatchesLineWidth(0);
    TPad *plotpad = new TPad("plotpad", "Pad containing the overlay plot",0.,0.,0.775,1);
    plotpad->Draw();
    plotpad->cd();
    ...
    plotpad->SetBottomMargin(0.25);
    plotpad->SetFrameFillStyle(0);
    plotpad->SetFrameBorderMode(0);
    plotpad->SetFrameFillStyle(0);
    plotpad->SetFrameBorderMode(0);

   TH1F *hSum = new TH1F("hSum","",31,0,31);
   hSum->SetMinimum(0.4);
   hSum->SetMaximum(30000);
   hSum->SetDirectory(0);
   hSum->SetStats(0);
   // hSum->Draw();
   ...
   hSum->GetXaxis()->SetTitle("E_{T}^{miss} [GeV]");
    ...
    hSum->GetXaxis()->SetBinLabel(28,"250#scale[0.7]{ }#minus#scale[0.5]{ }350");
    hSum->GetXaxis()->SetBinLabel(29,"350#scale[0.7]{ }#minus#scale[0.5]{ }450");
    hSum->GetXaxis()->SetBinLabel(30,"450#scale[0.7]{ }#minus#scale[0.5]{ }550");
    hSum->GetXaxis()->SetBinLabel(31,"#geq#scale[0.5]{ }550");
   ...
   hSum->GetXaxis()->SetTitleSize(0.05);
    ...
    hSum->GetXaxis()->SetTitleOffset(2.45);
...
/*
    ...
    */
    ...
    prefit->SetFillColor(  kCyan+1);
    prefit->SetMarkerColor(kCyan+2);
    prefit->SetLineColor(  kCyan+2);
    prefit->SetMarkerStyle(22);
    prefit->SetLineStyle(0);
    prefit->SetFillStyle(3145);
    leg->AddEntry(prefit, "Prefit background", "f");
    prefit->Draw("sameE2");
    
    //orig: kRed-7
    //tried kRed-6
    postfit->SetFillColor(  kMagenta+1);
    postfit->SetMarkerColor(kMagenta+2);
    postfit->SetLineColor(  kMagenta+2);
    postfit->SetMarkerStyle(23);
    postfit->SetLineStyle(0);
    postfit->SetFillStyle(3154);
    postfit->Draw("sameE2");
    ...
    leg->AddEntry(postfit, "Postfit background", "f");
...
*/
    ...
    tCMS->SetLineWidth(2);
    tCMS->Draw();
    TLatex *tPrel = new TLatex(0.20,0.944,"Preliminary");
    tPrel->SetNDC();
    ...
    hMCrat->Draw("E2");
    TLine *rline = new TLine(0,1,31,1);
    ...
    texld->Draw();
    TLine *lr = new TLine(27,0.25,27,3.95);
    lr->SetLineStyle(7);
    lr->SetLineWidth(4);
...
*/
    ...
    TLatex *txA = new TLatex(0.01,0.945,"#splitline{A: N_{J} #leq 3, t_{mod} > 10,}{     M_{#font[12]{l}b} #leq 175 GeV}");
    txA->SetNDC();txA->SetTextAlign(13);txA->SetTextFont(42);txA->SetTextSize(0.1);txA->SetLineWidth(2);
    txA->Draw();
    TLatex *txB = new TLatex(0.01,0.85,"#splitline{B: N_{J} #leq 3, t_{mod} > 10,}{     M_{#font[12]{l}b} > 175 GeV}");
    txB->SetNDC();txB->SetTextAlign(13);txB->SetTextFont(42);txB->SetTextSize(0.1);txB->SetLineWidth(2);
    txB->Draw();
    TLatex *txC = new TLatex(0.01,0.755,"#splitline{C: N_{J} #geq 4, t_{mod} #leq 0,}{     M_{#font[12]{l}b} #leq 175 GeV}");
    txC->SetNDC();txC->SetTextAlign(13);txC->SetTextFont(42);txC->SetTextSize(0.1);txC->SetLineWidth(2);
    txC->Draw();
    TLatex *txD = new TLatex(0.01,0.66,"#splitline{D: N_{J} #geq 4, t_{mod} #leq 0,}{     M_{#font[12]{l}b} > 175 GeV}");
    txD->SetNDC();txD->SetTextAlign(13);txD->SetTextFont(42);txD->SetTextSize(0.1);txD->SetLineWidth(2);
    txD->Draw();
    TLatex *txE = new TLatex(0.01,0.565,"#splitline{E: N_{J} #geq 4, 0 < t_{mod} #leq 10,}{     M_{#font[12]{l}b} #leq 175 GeV}");
    txE->SetNDC();txE->SetTextAlign(13);txE->SetTextFont(42);txE->SetTextSize(0.1);txE->SetLineWidth(2);
    txE->Draw();
    TLatex *txF = new TLatex(0.01,0.47,"#splitline{F: N_{J} #geq 4, 0 < t_{mod} #leq 10,}{     M_{#font[12]{l}b} > 175 GeV}");
    txF->SetNDC();txF->SetTextAlign(13);txF->SetTextFont(42);txF->SetTextSize(0.1);txF->SetLineWidth(2);
    txF->Draw();
    TLatex *txG = new TLatex(0.01,0.375,"#splitline{G: N_{J} #geq 4, t_{mod} > 10,}{     M_{#font[12]{l}b} #leq 175 GeV}");
    txG->SetNDC();txG->SetTextAlign(13);txG->SetTextFont(42);txG->SetTextSize(0.1);txG->SetLineWidth(2);
    txG->Draw();
    TLatex *txH = new TLatex(0.01,0.28,"#splitline{H: N_{J} #geq 4, t_{mod} > 10,}{     M_{#font[12]{l}b} > 175 GeV}");
    txH->SetNDC();txH->SetTextAlign(13);txH->SetTextFont(42);txH->SetTextSize(0.1);txH->SetLineWidth(2);
    txH->Draw();
    TLatex *txI = new TLatex(0.01,0.155,"#splitline{I: Compressed}{     region}");
    txI->SetNDC();txI->SetTextAlign(13);txI->SetTextFont(42);txI->SetTextSize(0.1);txI->SetLineWidth(2);
    txI->Draw();
    TLine *lv = new TLine(0.01,0.1775,0.91,0.1775);
    lv->SetNDC();
    lv->SetLineStyle(7);
    lv->SetLineWidth(4);
   ...
   c1->cd();
    c1->Update();
   c1->SetSelected(c1);
    c1->SaveAs("PrefitPostfitPlot_Moriond2017.eps");
