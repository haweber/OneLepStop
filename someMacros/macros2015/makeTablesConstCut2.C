...
void makeTablesConstCut2(){
    ...
    load(varb1,cutb1,bgb1,sig425b1,sig500b1,sig650b1,sig850b1,1,"MTDeltaPhiconstcut.txt");
    ...
    //load(ds,d1,d2,SBsig425b1,SBsig500b1,SBsig650b1,SBsig850b1,2,"_add1bconstcut.txt");
    //load(ds,d1,d2,SsBsig425b1,SsBsig500b1,SsBsig650b1,SsBsig850b1,3,"_add1bconstcut.txt");
    //load(ds,d1,d2,FoMsig425b1,FoMsig500b1,FoMsig650b1,FoMsig850b1,4,"_add1bconstcut.txt");
    //load(ds,d1,d2,Zsig425b1,Zsig500b1,Zsig650b1,Zsig850b1,5,"_add1bconstcut.txt");
    
    load(METvarb1,METcutb1,METbgb1,METsig425b1,METsig500b1,METsig650b1,METsig850b1,1,"MET300/MTDeltaPhiconstcut.txt");
    ...
    //load(ds,d1,d2,METSBsig425b1,METSBsig500b1,METSBsig650b1,METSBsig850b1,2,"MET300/_add1bconstcut.txt");
    //load(ds,d1,d2,METSsBsig425b1,METSsBsig500b1,METSsBsig650b1,METSsBsig850b1,3,"MET300/_add1bconstcut.txt");
    //load(ds,d1,d2,METFoMsig425b1,METFoMsig500b1,METFoMsig650b1,METFoMsig850b1,4,"MET300/_add1bconstcut.txt");
    //load(ds,d1,d2,METZsig425b1,METZsig500b1,METZsig650b1,METZsig850b1,5,"MET300/_add1bconstcut.txt");
    
    load(chivarb1,chicutb1,chibgb1,chisig425b1,chisig500b1,chisig650b1,chisig850b1,1,"chi210/MTDeltaPhiconstcut.txt");
    ...
    //load(ds,d1,d2,chiSBsig425b1,chiSBsig500b1,chiSBsig650b1,chiSBsig850b1,2,"chi210/_add1bconstcut.txt");
    //load(ds,d1,d2,chiSsBsig425b1,chiSsBsig500b1,chiSsBsig650b1,chiSsBsig850b1,3,"chi210/_add1bconstcut.txt");
    //load(ds,d1,d2,chiFoMsig425b1,chiFoMsig500b1,chiFoMsig650b1,chiFoMsig850b1,4,"chi210/_add1bconstcut.txt");
    //load(ds,d1,d2,chiZsig425b1,chiZsig500b1,chiZsig650b1,chiZsig850b1,5,"chi210/_add1bconstcut.txt");
    
    load(MTWvarb1,MTWcutb1,MTWbgb1,MTWsig425b1,MTWsig500b1,MTWsig650b1,MTWsig850b1,1,"MT2W200/MTDeltaPhiconstcut.txt");
    ...
    //load(ds,d1,d2,MTWSBsig425b1,MTWSBsig500b1,MTWSBsig650b1,MTWSBsig850b1,2,"MT2W200/_add1bconstcut.txt");
    //load(ds,d1,d2,MTWSsBsig425b1,MTWSsBsig500b1,MTWSsBsig650b1,MTWSsBsig850b1,3,"MT2W200/_add1bconstcut.txt");
    //load(ds,d1,d2,MTWFoMsig425b1,MTWFoMsig500b1,MTWFoMsig650b1,MTWFoMsig850b1,4,"MT2W200/_add1bconstcut.txt");
    //load(ds,d1,d2,MTWZsig425b1,MTWZsig500b1,MTWZsig650b1,MTWZsig850b1,5,"MT2W200/_add1bconstcut.txt");
    ...
    load(varb2,cutb2,bgb2,sig425b2,sig500b2,sig650b2,sig850b2,1,"MTDeltaPhiconstcut.txt");
    ...
    load(METvarb2,METcutb2,METbgb2,METsig425b2,METsig500b2,METsig650b2,METsig850b2,1,"MET300/MTDeltaPhiconstcut.txt");
    ...
    load(chivarb2,chicutb2,chibgb2,chisig425b2,chisig500b2,chisig650b2,chisig850b2,1,"chi210/MTDeltaPhiconstcut.txt");
    ...
    load(MTWvarb2,MTWcutb2,MTWbgb2,MTWsig425b2,MTWsig500b2,MTWsig650b2,MTWsig850b2,1,"MT2W200/MTDeltaPhiconstcut.txt");
    ...
    load(varj2,cutj2,bgj2,sig425j2,sig500j2,sig650j2,sig850j2,1,"MTDeltaPhiconstcut.txt");
    ...
    //load(ds,d1,d2,SBsig425j2,SBsig500j2,SBsig650j2,SBsig850j2,2,"_add2jconstcut.txt");
    //load(ds,d1,d2,SsBsig425j2,SsBsig500j2,SsBsig650j2,SsBsig850j2,3,"_add2jconstcut.txt");
    //load(ds,d1,d2,FoMsig425j2,FoMsig500j2,FoMsig650j2,FoMsig850j2,4,"_add2jconstcut.txt");
    //load(ds,d1,d2,Zsig425j2,Zsig500j2,Zsig650j2,Zsig850j2,5,"_add2jconstcut.txt");
    
    load(METvarj2,METcutj2,METbgj2,METsig425j2,METsig500j2,METsig650j2,METsig850j2,1,"MET300/MTDeltaPhiconstcut.txt");
    ...
    //load(ds,d1,d2,METSBsig425j2,METSBsig500j2,METSBsig650j2,METSBsig850j2,2,"MET300/_add2jconstcut.txt");
    //load(ds,d1,d2,METSsBsig425j2,METSsBsig500j2,METSsBsig650j2,METSsBsig850j2,3,"MET300/_add2jconstcut.txt");
    //load(ds,d1,d2,METFoMsig425j2,METFoMsig500j2,METFoMsig650j2,METFoMsig850j2,4,"MET300/_add2jconstcut.txt");
    //load(ds,d1,d2,METZsig425j2,METZsig500j2,METZsig650j2,METZsig850j2,5,"MET300/_add2jconstcut.txt");
    
    load(chivarj2,chicutj2,chibgj2,chisig425j2,chisig500j2,chisig650j2,chisig850j2,1,"chi210/MTDeltaPhiconstcut.txt");
    ...
    //load(ds,d1,d2,chiSBsig425j2,chiSBsig500j2,chiSBsig650j2,chiSBsig850j2,2,"chi210/_add2jconstcut.txt");
    //load(ds,d1,d2,chiSsBsig425j2,chiSsBsig500j2,chiSsBsig650j2,chiSsBsig850j2,3,"chi210/_add2jconstcut.txt");
    //load(ds,d1,d2,chiFoMsig425j2,chiFoMsig500j2,chiFoMsig650j2,chiFoMsig850j2,4,"chi210/_add2jconstcut.txt");
    //load(ds,d1,d2,chiZsig425j2,chiZsig500j2,chiZsig650j2,chiZsig850j2,5,"chi210/_add2jconstcut.txt");
    
    load(MTWvarj2,MTWcutj2,MTWbgj2,MTWsig425j2,MTWsig500j2,MTWsig650j2,MTWsig850j2,1,"MT2W200/MTDeltaPhiconstcut.txt");
    ...
    //load(ds,d1,d2,MTWSBsig425j2,MTWSBsig500j2,MTWSBsig650j2,MTWSBsig850j2,2,"MT2W200/_add2jconstcut.txt");
    //load(ds,d1,d2,MTWSsBsig425j2,MTWSsBsig500j2,MTWSsBsig650j2,MTWSsBsig850j2,3,"MT2W200/_add2jconstcut.txt");
    //load(ds,d1,d2,MTWFoMsig425j2,MTWFoMsig500j2,MTWFoMsig650j2,MTWFoMsig850j2,4,"MT2W200/_add2jconstcut.txt");
    //load(ds,d1,d2,MTWZsig425j2,MTWZsig500j2,MTWZsig650j2,MTWZsig850j2,5,"MT2W200/_add2jconstcut.txt");
    ...
    load(varj1,cutj1,bgj1,sig425j1,sig500j1,sig650j1,sig850j1,1,"MTDeltaPhiconstcut.txt");
    ...
    //load(ds,d1,d2,SBsig425j1,SBsig500j1,SBsig650j1,SBsig850j1,2,"_add1jconstcut.txt");
    //load(ds,d1,d2,SsBsig425j1,SsBsig500j1,SsBsig650j1,SsBsig850j1,3,"_add1jconstcut.txt");
    //load(ds,d1,d2,FoMsig425j1,FoMsig500j1,FoMsig650j1,FoMsig850j1,4,"_add1jconstcut.txt");
    //load(ds,d1,d2,Zsig425j1,Zsig500j1,Zsig650j1,Zsig850j1,5,"_add1jconstcut.txt");
    
    load(METvarj1,METcutj1,METbgj1,METsig425j1,METsig500j1,METsig650j1,METsig850j1,1,"MET300/MTDeltaPhiconstcut.txt");
    ...
    //load(ds,d1,d2,METSBsig425j1,METSBsig500j1,METSBsig650j1,METSBsig850j1,2,"MET300/_add1jconstcut.txt");
    //load(ds,d1,d2,METSsBsig425j1,METSsBsig500j1,METSsBsig650j1,METSsBsig850j1,3,"MET300/_add1jconstcut.txt");
    //load(ds,d1,d2,METFoMsig425j1,METFoMsig500j1,METFoMsig650j1,METFoMsig850j1,4,"MET300/_add1jconstcut.txt");
    //load(ds,d1,d2,METZsig425j1,METZsig500j1,METZsig650j1,METZsig850j1,5,"MET300/_add1jconstcut.txt");
    
    load(chivarj1,chicutj1,chibgj1,chisig425j1,chisig500j1,chisig650j1,chisig850j1,1,"chi210/MTDeltaPhiconstcut.txt");
    ...
    //load(ds,d1,d2,chiSBsig425j1,chiSBsig500j1,chiSBsig650j1,chiSBsig850j1,2,"chi210/_add1jconstcut.txt");
    //load(ds,d1,d2,chiSsBsig425j1,chiSsBsig500j1,chiSsBsig650j1,chiSsBsig850j1,3,"chi210/_add1jconstcut.txt");
    //load(ds,d1,d2,chiFoMsig425j1,chiFoMsig500j1,chiFoMsig650j1,chiFoMsig850j1,4,"chi210/_add1jconstcut.txt");
    //load(ds,d1,d2,chiZsig425j1,chiZsig500j1,chiZsig650j1,chiZsig850j1,5,"chi210/_add1jconstcut.txt");
    
    load(MTWvarj1,MTWcutj1,MTWbgj1,MTWsig425j1,MTWsig500j1,MTWsig650j1,MTWsig850j1,1,"MT2W200/MTDeltaPhiconstcut.txt");
    ...
    //load(ds,d1,d2,MTWSBsig425j1,MTWSBsig500j1,MTWSBsig650j1,MTWSBsig850j1,2,"MT2W200/_add1jconstcut.txt");
    //load(ds,d1,d2,MTWSsBsig425j1,MTWSsBsig500j1,MTWSsBsig650j1,MTWSsBsig850j1,3,"MT2W200/_add1jconstcut.txt");
    //load(ds,d1,d2,MTWFoMsig425j1,MTWFoMsig500j1,MTWFoMsig650j1,MTWFoMsig850j1,4,"MT2W200/_add1jconstcut.txt");
    //load(ds,d1,d2,MTWZsig425j1,MTWZsig500j1,MTWZsig650j1,MTWZsig850j1,5,"MT2W200/_add1jconstcut.txt");
