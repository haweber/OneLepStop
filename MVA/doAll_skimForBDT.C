{
  gROOT->ProcessLine(".L TestBDTcreatetrees_forReal.C+");
  //gROOT->ProcessLine(".L TestBDTcreatetrees_forRealPlusAddingBDTscores.C+");
  
  const unsigned int chainsize = 21;
  TChain *ch[chainsize];
  string ds[chainsize];
  ...
  /*
  ds[3] = "TTJets_DiLept_madgraph_25ns_1";
  ch[3] = new TChain("t"); 
  myhelper = babylocation+"TTJets_DiLept_madgraph_25ns_1.root"; ch[3]->Add(myhelper.c_str());
  ds[4] = "TTJets_DiLept_madgraph_25ns_2";
  ch[4] = new TChain("t"); 
  myhelper = babylocation+"TTJets_DiLept_madgraph_25ns_2.root";  ch[4]->Add(myhelper.c_str());
  babylocation = "/nfs-7/userdata/stopRun2/CMS3_V07-04-XX/v7.4.x_v5/";
  */
  ds[3] = "TTJets_DiLept_madgraph_25ns";
  ch[3] = new TChain("t"); 
  myhelper = babylocation+"TTJets_DiLept_madgraph_25ns_1.root"; ch[3]->Add(myhelper.c_str());
  myhelper = babylocation+"TTJets_DiLept_madgraph_25ns_2.root"; ch[3]->Add(myhelper.c_str());
  babylocation = "/nfs-7/userdata/stopRun2/StopBabies__CMS3_V07-04-XX/Spring15_25ns_Samples/StopBabyMaker__v7.4.x_v5/Skim__METge30__LEPge1_elPt20_elEta2p1_muPt20_muEta2p1_vetoElPt5_vetoElEta2p4_vetoMuPt5_vetoMuEta2p4__JETge1_jPt30_jEta2p4__20150728/";
  ds[4] = "TTbar_amcnlo";
  ch[4] = new TChain("t"); 
  myhelper = babylocation+"ttbar_amcnlo_pythia8_25ns.root"; ch[4]->Add(myhelper.c_str());
  babylocation = "/nfs-7/userdata/stopRun2/CMS3_V07-04-XX/v7.4.x_v5/";
  ds[ 5] = "T2bw_600_187p5_50";
  ch[ 5] = new TChain("t"); 
  myhelper = babylocation+"priv_T2bw_600_187p5_50.root";     ch[ 5]->Add(myhelper.c_str());
  ds[ 6] = "T2bw_600_325_50";
  ch[ 6] = new TChain("t"); 
  myhelper = babylocation+"priv_T2bw_600_325_50.root";       ch[ 6]->Add(myhelper.c_str());
  ds[ 7] = "T2bw_600_462p5_50";
  ch[ 7] = new TChain("t"); 
  myhelper = babylocation+"priv_T2bw_600_462p5_50.root";     ch[ 7]->Add(myhelper.c_str());
  ds[ 8] = "T2bw_700_250_100";
  ch[ 8] = new TChain("t"); 
  myhelper = babylocation+"priv_T2bw_700_250_100.root";      ch[ 8]->Add(myhelper.c_str());
  ds[ 9] = "T2bw_700_400_100";
  ch[ 9] = new TChain("t"); 
  myhelper = babylocation+"priv_T2bw_700_400_100.root";      ch[ 9]->Add(myhelper.c_str());
  ds[10] = "T2bw_700_550_100";
  ch[10] = new TChain("t"); 
  myhelper = babylocation+"priv_T2bw_700_550_100.root";      ch[10]->Add(myhelper.c_str());
  ds[11] = "T2tb_700_250_100";
  ch[11] = new TChain("t"); 
  myhelper = babylocation+"priv_T2tb_700_250_100.root";      ch[11]->Add(myhelper.c_str());
  ds[12] = "T2tb_700_400_100";
  ch[12] = new TChain("t"); 
  myhelper = babylocation+"priv_T2tb_700_400_100.root";      ch[12]->Add(myhelper.c_str());
  ds[13] = "T2tb_700_550_100";
  ch[13] = new TChain("t"); 
  ...
  ds[18] = "WJets";
  ch[18] = new TChain("t"); 
  myhelper = babylocation+"WJetsToLNu_HT100To200_madgraph_pythia8_25ns.root";      ch[18]->Add(myhelper.c_str());
  myhelper = babylocation+"WJetsToLNu_HT200To400_madgraph_pythia8_25ns.root";      ch[18]->Add(myhelper.c_str());
  myhelper = babylocation+"WJetsToLNu_HT400To600_madgraph_pythia8_25ns.root";      ch[18]->Add(myhelper.c_str());
  myhelper = babylocation+"WJetsToLNu_HT600ToInf_madgraph_pythia8_25ns.root";      ch[18]->Add(myhelper.c_str());
  ds[19] = "DYJets";
  ch[19] = new TChain("t"); 
  myhelper = babylocation+"DYJetsToLL_m10To50_amcnlo_pythia8_25ns.root";  ch[19]->Add(myhelper.c_str());
  myhelper = babylocation+"DYJetsToLL_m50_amcnlo_pythia8_25ns.root";      ch[19]->Add(myhelper.c_str());
  ds[20] = "TTbar_madgraph";
  ch[20] = new TChain("t"); 
  myhelper = babylocation+"ttbar_madgraph_pythia8_25ns.root"; ch[20]->Add(myhelper.c_str());
