...
*/
  ...
  for(unsigned int b = 0; b<3; ++b){
    ...
    if((skimFilePrefix!="TTbar"&&skimFilePrefix!="TTbar_amcnlo"&&skimFilePrefix!="TTbar_madgraph")&&b>0) continue;
    ...
    if(skimFilePrefix=="TTbar_amcnlo"&&b==0) samplename = "TTbar1l_amcnlo";
    if(skimFilePrefix=="TTbar_amcnlo"&&b==1) samplename = "TTbar2l_amcnlo";
    if(skimFilePrefix=="TTbar_amcnlo"&&b==2) samplename = "TTbarH_amcnlo";
    if(skimFilePrefix=="TTbar_madgraph"&&b==0) samplename = "TTbar1l_madgraph";
    if(skimFilePrefix=="TTbar_madgraph"&&b==1) samplename = "TTbar2l_madgraph";
    if(skimFilePrefix=="TTbar_madgraph"&&b==2) samplename = "TTbarH_madgraph";
    //TString fileName = "/hadoop/cms/store/user/haweber/forBDT/"+samplename+".root";
    TString fileName = "/nfs-7/userdata/stopRun2/testMVA/"+samplename+".root";
  ...
  while ( (currentFile = (TFile*)fileIter.Next()) ) {
	...
	if(cms3.gen_nfromtmus_() + cms3.gen_nfromtels_() + cms3.gen_nfromttaus_() ==2) { samplename = "TTbar2l"; sampleid=1; }
      ...
      if(skimFilePrefix=="TTbar_amcnlo"){
	if(cms3.gen_nfromtmus_() + cms3.gen_nfromtels_() + cms3.gen_nfromttaus_() ==2) { samplename = "TTbar2l_amcnlo"; sampleid=1; }
	else if(cms3.gen_nfromtmus_() + cms3.gen_nfromtels_() + cms3.gen_nfromttaus_() ==1) { samplename = "TTbar1l_amcnlo"; sampleid=0; }
	else { samplename = "TTbarH_amcnlo"; sampleid=2; }
      }
      if(skimFilePrefix=="TTbar_madgraph"){
	if(cms3.gen_nfromtmus_() + cms3.gen_nfromtels_() + cms3.gen_nfromttaus_() ==2) { samplename = "TTbar2l_madgraph"; sampleid=1; }
	else if(cms3.gen_nfromtmus_() + cms3.gen_nfromtels_() + cms3.gen_nfromttaus_() ==1) { samplename = "TTbar1l_madgraph"; sampleid=0; }
	else { samplename = "TTbarH_madgraph"; sampleid=2; }
      }
      // Analysis Code
